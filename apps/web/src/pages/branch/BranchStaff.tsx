...
import { getStaff, updateStaff } from '@/lib/staffApi';
...
export function BranchStaff() {
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        title="Branch Staff"
        subtitle="View and manage staff assigned to your branch"
      />
        ...
        {staff.map((s) => (
          <Card key={s.id} className="flex items-center gap-3">
            ...
            <div
              ...
              style={{ backgroundColor: s.avatarColor || roleColors[s.staffProfile?.staffType ?? s.role] || '#64748B' }}
            >
              {s.fullName.charAt(0)}
            </div>
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="text-xs text-muted">
                ...
                {s.staffProfile?.specialization && (
                  <span> · {s.staffProfile.specialization}</span>
                )}
              </div>
